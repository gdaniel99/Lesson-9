---
title: 'Homework 6: Installations'
author: "Gaea Daniel"
date: "3/22/2017"
output:
...
```{r}
path <- "/Users/gdaniel99/RStudio Stuff/Lesson-9/MiSeq_SOP/" # CHANGE THIS to the directory containing the fastq files after unzipping
fns <- list.files(path)
fns
```

```{r}
path2 <- "/Users/gdaniel99/RStudio Stuff/Lesson-9/" # CHANGE THIS to the directory containing the fastq files after unzipping
